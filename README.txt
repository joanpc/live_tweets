...
It's a simple module that displays a block whit a tweet search feed updated in realtime.
...
enable it and add some keywords to the "Search keywords fields" in the block configuration page.
